...
/**
 * This is a straight copy of the original core class, just without being final.
 * This enables us to copy the core class 1:1 and extend it, without mixing up custom and core classes.
 */
class CoreSelectViewHelper extends AbstractFormFieldViewHelper
{
    /**
     * @var string
     */
